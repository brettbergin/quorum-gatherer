...
# The installed quorum_core package directory (…/quorum_core/quorum_core).
...
class Settings(BaseSettings):
    ...
    # Where the agent definition files live (packaged with quorum_core, so it resolves
    # both in a source checkout and inside a PyInstaller bundle).
    agent_prompts_dir: Path = PACKAGE_DIR / "agent_prompts"
