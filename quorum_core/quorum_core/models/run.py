...
from quorum_core.models.enums import AgentRunPhase, AgentRunStatus
...
class AgentRun(TimestampMixin, Base):
    ...
    # pydantic-ai serialized conversation (JSON string) for this agent's chat thread (deliberation
    # runs only): seeded after the initial run, extended on each user follow-up turn.
    message_history: Mapped[str | None] = mapped_column(Text)
